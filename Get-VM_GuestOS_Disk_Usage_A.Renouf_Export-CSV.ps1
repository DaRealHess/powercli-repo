...
$MyCollection | Export-Csv -NoTypeInformation -path C:\PowerShell_Scripts\Outputs\HHB_All-VMs_Disk_Usage.csv
# apart from Export-Csv, ConvertTo-Html or ConvertTo-Xml can be used
